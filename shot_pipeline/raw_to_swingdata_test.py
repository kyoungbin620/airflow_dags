...
with DAG(
    ...
    raw_to_base = SparkKubernetesOperator(
        ...
        namespace="airflow",
        application_file="dags/shot_pipeline/raw-to-base.yaml",
    ...
    base_to_swing = SparkKubernetesOperator(
        ...
        namespace="airflow",
        application_file="dags/shot_pipeline/base-to-swing.yaml",
        kubernetes_conn_id="kubernetes_default",
        delete_on_termination=True,
        reattach_on_restart=True,
        get_logs=True,
    ...
    swing_to_db = SparkKubernetesOperator(
        ...
        namespace="airflow",
        application_file="dags/shot_pipeline/swing-to-db.yaml",
        kubernetes_conn_id="kubernetes_default",
        delete_on_termination=True,
        reattach_on_restart=True,
        get_logs=True,
